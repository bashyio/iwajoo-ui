...
Copyright 2014 Bram Stein. http://bramstein.com
License BSD
*/
...
Copyright 2014-2015 Bram Stein. http://bramstein.com
License BSD
*/
...
/*!
Font Loading with Font Events Demo
...
var interval = setInterval(function(){
    ...
    timesRun += 1;
	var font1 = new FontFaceObserver( "Rubik", {
		weight: 300
	});
	var font2 = new FontFaceObserver( "Rubik", {
		weight: 400
	});
	var font3 = new FontFaceObserver( "Rubik", {
		weight: 500
	});
	Promise.all([
		font1.check(),
		...
		document.documentElement.className += " fonts-loaded";
		  ...
		  console.log('Font notloaded yet');
